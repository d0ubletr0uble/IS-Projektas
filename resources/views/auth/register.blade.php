                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="first-name" class="col-md-4 col-form-label text-md-right">Vardas</label>
                        ...
                        <div class="form-group row">
                            <label for="last-name" class="col-md-4 col-form-label text-md-right">Pavardė</label>
                        ...
                        <div class="form-group row">
                            <label for="birthday" class="col-md-4 col-form-label text-md-right">Gimimo diena</label>
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">Splapyvardis</label>
                        ...
                        <div class="form-group row">
                            <label for="security-question" class="col-md-4 col-form-label text-md-right">Saugos klausimas</label>

                            <div class="col-md-6">
                                <input id="security-question" type="text" class="form-control @error('security-question') is-invalid @enderror" name="security-question" value="{{ old('security-question') }}" required autocomplete="security-question">

                                @error('security-question')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                        ...
                        <div class="form-group row">
                            <label for="security-answer" class="col-md-4 col-form-label text-md-right">Saugos atsakymas</label>

                            <div class="col-md-6">
                                <input id="security-answer" type="text" class="form-control @error('security-answer') is-invalid @enderror" name="security-answer" value="{{ old('security-answer') }}" required autocomplete="security-answer">

                                @error('security-answer')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">Telefono Nr. (neprivaloma)</label>
